      ...
      <section className="container">
        <section>
          ...
          <article>
            ...
            <ul>
              <li>
                <b>Tipo de mascota:</b> Decide qué tipo de mascota se adapta
                mejor a tu estilo de vida, ya sea un perro, un gato, un pájaro,
                un conejo, etc. Cada especie tiene diferentes necesidades y
                requerirá diferentes cuidados.
              </li>
              <li>
              ...
              <li>
                <b>Tiempo:</b> Las mascotas requieren tiempo y atención. Piensa
                en cuánto tiempo tienes disponible para dedicarle a tu mascota
                cada día. Algunas mascotas, como los perros, necesitan mucho
                tiempo de ejercicio y socialización.
              </li>
              <li>
                <b>Costos:</b> Tener una mascota conlleva gastos, como
                alimentos, atención veterinaria, juguetes, y otros accesorios.
                Asegúrate de poder cubrir estos costos antes de adoptar una
                mascota
              </li>
              <li>
                <b>Compromiso a largo plazo:</b> Las mascotas viven muchos años,
                así que asegúrate de estar listo para el compromiso a largo
                plazo que implica cuidar de una mascota.
              </li>
              <li>
              ...
              <li>
                <b>Condiciones de adopción:</b> Infórmate sobre los requisitos
                de adopción en el refugio o centro de rescate donde planeas
                adoptar. Algunos lugares tienen criterios específicos que debes
                cumplir antes de adoptar.
              </li>
              <li>
                <b>Preparación del hogar:</b> Asegúrate de que tu hogar esté
                seguro y listo para recibir a tu nueva mascota. Esto incluye
                preparar un área para dormir, asegurar cualquier peligro
                potencial y tener todos los suministros necesarios.
              </li>
              <li>
        ...
        <section>
          ...
          <article>
            ...
            <ul>
              ...
              <li>
                <b>Acuerdo de adopción:</b> Los adoptantes suelen tener que
                firmar un acuerdo de adopción que establece los términos y
                condiciones de la adopción, incluyendo el compromiso de
                proporcionar cuidados adecuados a la mascota.
              </li>
              <li>
                <b>Tarifa de adopción:</b> Algunos lugares pueden requerir el
                pago de una tarifa de adopción que ayuda a cubrir los costos
                asociados con el cuidado de las mascotas en el refugio, como la
                atención veterinaria y la alimentación.
              </li>
            </ul>
            <p>
